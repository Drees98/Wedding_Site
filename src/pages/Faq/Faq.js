...
function Faq() {
    ...
    return(
        <div>
            ...
            <Collapse label="When is the RSVP deadline?"><p>The last day you will be able to submit your RSVP will be April 15th, 2026.</p></Collapse>
            <Collapse label="Who can I bring as a plus one?"><p>Please feel free to bring your children and your partner.</p></Collapse>
            ...
            <Collapse label="How will dinner be served?"><p>Dinner will be served in a buffet style. Please be mindful about gluten cross contamination when serving yourself.</p></Collapse>
        </div>
    )
}
export default Faq